...
cdef int AddrLib_computeSurfaceAddrFromCoordLinear(int x, int y, int bpp, int pitch):
...
cdef int AddrLib_computeSurfaceAddrFromCoordMicroTiled(int x, int y, int bpp, int pitch,
                                                       int tileMode):
...
cdef int AddrLib_computeSurfaceAddrFromCoordMacroTiled(int x, int y, int bpp, int pitch, int height,
